...
\bigskip
\noindent\textbf{Note on References vs.\ Bibliography:} The next section is ``References,'' which will be automatically generated by Bib\TeX. A ``References'' list contains only the sources cited in the report, whereas a ``Bibliography'' also includes sources read but not cited. This report uses ``References'' only.